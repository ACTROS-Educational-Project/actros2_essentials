...
#include "actros2_msgs/srv/reverse_string.hpp"

// Execute:
//  ros2 run services_ros2 server_node 
//  ros2 service list
//  ros2 service type /reverse_string
//  ros2 interface show actros2_msgs/srv/ReverseString
//  ros2 service call /reverse_string actros2_msgs/srv/ReverseString '{normal_sentence: "Hello World ROS2!!!!"}'

void reverse_sentence(const std::shared_ptr<actros2_msgs::srv::ReverseString::Request> request,
          std::shared_ptr<actros2_msgs::srv::ReverseString::Response>      response)
{
...
int main(int argc, char **argv)
{
  ...
  rclcpp::Service<actros2_msgs::srv::ReverseString>::SharedPtr service =
    node->create_service<actros2_msgs::srv::ReverseString>("reverse_string", &reverse_sentence);
