...
using SharedResponse = actros2_msgs::srv::ReverseString::Response::SharedPtr;
...
public:
  ...
  : Node("reverse_string_client"),
    counter_(0)
  {
    client_ = create_client<actros2_msgs::srv::ReverseString>("reverse_string");
  ...
  void timer_callback()
  {
    ...
    auto request = std::make_shared<actros2_msgs::srv::ReverseString::Request>();
...
private:
  rclcpp::Client<actros2_msgs::srv::ReverseString>::SharedPtr client_;
